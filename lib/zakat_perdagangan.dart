...
class ZakatPerdaganganCard extends StatefulWidget {
  @override
  _ZakatPerdaganganCardState createState() => _ZakatPerdaganganCardState();
}

class _ZakatPerdaganganCardState extends State<ZakatPerdaganganCard> {
              ...
              children: <Widget>[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: "Masukkan penghasilan pertahun ", //SET LABELNYA
...
class Zakat extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      zakatCounter.zakatPerdagangan(result),
