...
class ZakatRikazCard extends StatefulWidget {
  @override
  _ZakatRikazCardState createState() => _ZakatRikazCardState();
}

class _ZakatRikazCardState extends State<ZakatRikazCard> {
              ...
              children: <Widget>[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: "Masukkan harga barang temuan ", //SET LABELNYA
...
class Zakat extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      zakatCounter.zakatRikaz(result),
