...
class ZakatProfesiCard extends StatefulWidget {
  @override
  _ZakatProfesiCardState createState() => _ZakatProfesiCardState();
}

class _ZakatProfesiCardState extends State<ZakatProfesiCard> {
              ...
              children: <Widget>[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: "Masukkan penghasilan anda", //SET LABELNYA
...
class Zakat extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      zakatCounter.zakatProfesi(result),
